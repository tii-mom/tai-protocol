...
// The BountyFunc type is an adapter to allow the use of ordinary
// function as Bounty mutator.
type BountyFunc func(context.Context, *ent.BountyMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BountyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BountyMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BountyMutation", m)
}
...
// The PetSkillFunc type is an adapter to allow the use of ordinary
// function as PetSkill mutator.
type PetSkillFunc func(context.Context, *ent.PetSkillMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PetSkillFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PetSkillMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PetSkillMutation", m)
}
