...
func (_q *GuildQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *GuildQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *GuildQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *GuildQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *GuildQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *GuildQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *GuildQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(guild.Table, guild.Columns, sqlgraph.NewFieldSpec(guild.FieldID, field.TypeUUID))
	_spec.From = _q.sql
